...
def yolo3(path_img, path_weights, path_classes_names, path_cfg):
    ...
    # Opening file
    # Pay attention! If you're using Windows, yours path_img might looks like:
    # r'yolo-coco-data\coco.names'
    # or:
    # 'yolo-coco-data\\coco.names'
    with open(path_classes_names) as f:
