...
full_path_to_images = os.path.join(os.getcwd(), 'DS_TS')
...
# to this: + '\' +
# or to this: + '\\' +
with open(os.path.join(full_path_to_images, 'classes.names'), 'w') as names, \
     open(os.path.join(full_path_to_images, 'classes.txt'), 'r') as txt:
...
# to this: + '\' +
# or to this: + '\\' +
with open(os.path.join(full_path_to_images, 'ts_data.data'), 'w') as data:
    ...
    data.write('train = ' + os.path.join(full_path_to_images, 'train.txt') + '\n')

    # Location of the test.txt file
    data.write('valid = ' + os.path.join(full_path_to_images, 'test.txt') + '\n')

    # Location of the classes.names file
    data.write('names = ' + os.path.join(full_path_to_images, 'classes.names') + '\n')
